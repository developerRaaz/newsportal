...
<html lang="en">
    <head>
        ...
        <meta name="description" content="SZ SZ News Portal">
        <meta name="author" content="PHPGurukul">


        <!-- App title -->
        <title>SZ SZ News Portal | Admin Panel</title>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 account-pages ">
                                <div style="background-color:#17a2b8" class="text-center account-logo-box">
